...
md"""
### Load time series data and create dataframe
"""

# ╔═╡ eb04e35e-8f9a-4b31-8669-b62be4688705
# call function to load `inflow_df` and `weather_df`

# ╔═╡ 5d07ae5f-a7f0-4635-9e3e-fcb72925b6af
# call function to create time-based features (nb: here we need to input what lag values are used, what time features are used, and so forth)

# ╔═╡ 445b9b4f-3616-4b3a-aef0-0e4070d0436c
# insert plotting code to view time series data and its features over a given time period
...
md"""
Enter text here about the different data imputation methods used and include reference to Interpretable AI paper and algorithms...
"""
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "4f06c1fd7792519e83a61ddfbd9edc0dd3b33b62"
