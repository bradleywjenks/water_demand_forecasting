...
const IAI = Base.loaded_modules[first(k for (k, v) in Base.loaded_modules if k.name == "IAI")]

# ╔═╡ ff49c51e-4331-420a-9074-0a2d65d0ee3f
...
lnr = IAI.OptimalTrees.load_iris_tree(num_threads=1)
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "09b3863f691c08cbdd9bc0b5e05aaa73bb893586"
